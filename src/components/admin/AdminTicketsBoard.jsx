...
import {
  Loader2, RefreshCw, Search, Plus, ChevronDown, ChevronUp,
  Clock, Zap, CheckCircle2, Archive, Send, X, MessageSquare,
  User, Calendar, Tag, AlertTriangle, Filter
} from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-end">
      ...
      <div className="relative w-full max-w-2xl h-full bg-card border-l border-border/50 flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-border/40 flex items-start justify-between gap-4">
          ...
          <button onClick={onClose} className="p-2 rounded-lg hover:bg-muted text-muted-foreground hover:text-foreground transition-all flex-shrink-0">
            <X className="w-4 h-4" />
          </button>
        </div>
